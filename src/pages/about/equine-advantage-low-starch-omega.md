...
heading: Low Starch Omega +
subheading: >-
  A textured feed that is designed for horses that require moderate to
  significant calories in addition to their forage. 
heading_image: /img/EquineAdvantage_Render-1@2x.png
hero_image:
  alt: a horse
  image: /img/horse_balance.png
product_image: /img/EquineAdvantage_Render-1.png
advantages:
  icon:
